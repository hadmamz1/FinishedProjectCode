...
public class GameWindowImGui {

    private static float columnWidthDefault = 220.0f;

    public static void drawVec2Control(String label, Vector2f values) {
        drawVec2Control(label, values, 0.0f, columnWidthDefault);
    }

    public static void drawVec2Control(String label, Vector2f values, float resetValue) {
        drawVec2Control(label, values, resetValue, columnWidthDefault);
    }
