...
public class Physics {
    ...
    public void addBox2DCollider(Rigidbody2D rb, Box2DCollider boxCollider) {
        ...
        fixtureDef.userData = boxCollider.gameObj;
    ...
    public void addCircleCollider(Rigidbody2D rb, CircleCollider circleCollider) {
        ...
        fixtureDef.density = 1.0f;
        fixtureDef.friction = rb.getFriction();
        fixtureDef.userData = circleCollider.gameObj;
        fixtureDef.isSensor = rb.isSensor();
        body.createFixture(fixtureDef);
    }
    ...
    public Raycasting raycast(GameObject requestingObject, Vector2f point1, Vector2f point2) {
        Raycasting callback = new Raycasting(requestingObject);
    ...
    public static boolean checkOnGround(
        ...
        Raycasting info = Window.getPhysics().raycast(gameObject, raycastBegin, raycastEnd);
        ...
        Raycasting info2 = Window.getPhysics().raycast(gameObject, raycast2Begin, raycast2End);
