...
public class Listener_Mouse {
    private static Listener_Mouse instance;
    ...
    public static Listener_Mouse get() {
        if (Listener_Mouse.instance == null) {
            Listener_Mouse.instance = new Listener_Mouse();
        }

        return Listener_Mouse.instance;
    }
    ...
    public static Vector2f getWorld()
    {
        ...
        Matrix4f inverseProjection = new Matrix4f(camera.getInverseProjec());
    ...
    public static Vector2f worldToScreen(Vector2f worldCoords) {
        ...
        Matrix4f projection = new Matrix4f(camera.getProjecMatrix());
