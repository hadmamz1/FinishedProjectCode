...
import UtilityComponents.JMath;
...
public class Drawing {
    ...
    private static Shader shader = Resources.getShader("assets/shaders/debugLine2D.glsl");
    ...
    public static void addLine2D(Vector2f from, Vector2f to, Vector3f color, int lifetime) {
        ...
        Drawing.lines.add(new Line2D(from, to, color, lifetime));
    }
